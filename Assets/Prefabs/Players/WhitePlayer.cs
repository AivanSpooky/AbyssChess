...
public class WhitePlayer : BasePlayer
{
    public override void ExecuteAction(Vector2Int oldPos, Vector2Int newPos)
    {
        ...
        // ÌÅÍßŞ ÏÎÇÈÖÈŞ ÏÅĞÂÎÉ ÔÈÃÓĞÛ (ÁÅËÎÉ)
        ...
        // ÌÅÍßŞ ÏÎÇÈÖÈŞ ÂÎÇÌÎÆÍÎÉ ÂÒÎĞÎÉ ÔÈÃÓĞÛ (ÍÅ ÁÅËÀß)
        ...
        {
            chessboard.RemoveBlackPiece(pieces[oldPos.x, oldPos.y]);
